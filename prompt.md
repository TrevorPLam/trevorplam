...
If `TASKS.md` conflicts with current best practices, security guidance, official docs, or the actual architecture of the repo, follow the best‑supported approach and briefly explain the conflict.
...
3.  **Targeted Online Research (Current as of 04/2026):** Now, inform your understanding with external best practices.
    ...
    - **Focus Areas:** Your research should cover:
        ...
        - Anti‑patterns to avoid (many are already noted in `TASKS.md`)
...
- add a short completion note in `TASKS.md` (or in a separate log file) that includes:
  - what was changed
  - key files touched
